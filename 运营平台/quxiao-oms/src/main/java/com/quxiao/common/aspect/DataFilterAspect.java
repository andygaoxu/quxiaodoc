package com.quxiao.common.aspect;
...
import com.quxiao.common.annotaion.DataFilter;
...
import com.quxiao.oms.service.SysDeptService;
import com.quxiao.oms.service.SysRoleDeptService;
import com.quxiao.oms.service.SysUserRoleService;
import com.quxiao.oms.shiro.ShiroUtils;
...
public class DataFilterAspect {
    ...
    @Pointcut("@annotation(com.quxiao.common.annotaion.DataFilter)")
    ...
    public void dataFilter(JoinPoint point) throws Throwable {
        ...
        throw new QXException("数据权限接口，只能是Map类型参数，且不能为NULL");
    }
